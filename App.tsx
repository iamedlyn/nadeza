...
import SocialMediaStrategy from './src/pages/services/SocialMediaStrategy'; // ✅ Social Media
...
import FoodBeverage from './src/pages/industries/FoodBeverage'; // ✅ Food & Beverage
      ...
      <Router>
        <main className="min-h-screen font-inter">
          <Routes>
            ...
            <Route path="/services/social-media" element={<SocialMediaStrategy />} /> {/* ✅ NEW */}
            ...
            <Route path="/industries/restaurant-food-beverage" element={<FoodBeverage />} /> {/* ✅ NEW */}
